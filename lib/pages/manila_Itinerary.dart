                        ...
                        child: FlutterMap(
                          ...
                          children: [
                            ...
                            MarkerLayer(markers: [
                              ...
                              Marker(
                                  point: LatLng(
                                      14.599700927734375, 121.015380859375),
                                  child: Icon(
                                    Icons.pin_drop,
                                    color: Colors.red,
                                    size: 15,
                              ...
                              Marker(
                                  point: LatLng(
                                      14.623331513423873, 120.96385959093604),
                                  width: 10,
                                  height: 10,
                                  child: Icon(Icons.pin_drop,
                                      color: Colors.red, size: 15)),
                              ...
                              Marker(
                                  point: LatLng(
                                      14.597673533240254, 120.97837927648348),
                                  child: Icon(
                                    Icons.pin_drop,
                                    color: Colors.red,
                                    size: 15,
                              ...
                              Marker(
                                  point: LatLng(
                                      14.581898795391808, 121.01649271993001),
                                  width: 10,
                                  height: 10,
                                  child: Icon(
                                    Icons.pin_drop,
                  ...
                  Row(
                    ...
                    children: [
                      Container(
                        ...
                        child: Center(
                          child: Text(
                            "YOUR 5 HOURS SUGGESTED ITINERARY",
                            style: TextStyle(
                                fontFamily: 'FSP-Demo',
                                fontSize: 15,
                                color: Colors.white),
