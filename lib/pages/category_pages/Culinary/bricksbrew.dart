...
class Bricksbrew extends StatefulWidget {
  const Bricksbrew({Key? key}) : super(key: key);

  @override
  State<Bricksbrew> createState() => _BricksbrewState();
}

class _BricksbrewState extends State<Bricksbrew> {
            ...
            children: [
              ...
              Row(
                  ...
                  children: [
                    Center(
                      child: Text(
                        "Bricks and Brew", style: TextStyle(
                          fontFamily: 'FSP-Demo',
              ...
              Row(
                ...
                children: [
                  GestureDetector(
                    onDoubleTap: () {
                      addFavorites("Bricks & Brew", "images/category_images/CULINARIES/BricksBrew.jpg");
                    },
                    child: Container(
                      width: 325,
                      height: 200,
