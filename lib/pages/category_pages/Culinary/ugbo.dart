...
class Ugbo extends StatefulWidget {
  const Ugbo({Key? key}) : super(key: key);

  @override
  State<Ugbo> createState() => _UgboState();
}

class _UgboState extends State<Ugbo> {
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  GestureDetector(
                    onDoubleTap: () {
                      addFavorites("Ugbo", "images/category_images/CULINARIES/Ugbo.jpeg");
                    },
                    child: Container(
                      width: 325,
                      height: 200,
