...
class LaCathedral extends StatefulWidget {
  const LaCathedral({Key? key}) : super(key: key);

  @override
  State<LaCathedral> createState() => _LaCathedralState();
}

class _LaCathedralState extends State<LaCathedral> {
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  GestureDetector(
                    onDoubleTap: () {
                      addFavorites("La Cathedral Cafe", "images/category_images/CULINARIES/LaCathedral-1.jpg");
                    },
                    child: Container(
                      width: 325,
                      height: 200,
