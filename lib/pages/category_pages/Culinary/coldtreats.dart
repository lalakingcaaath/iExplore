...
class ColdTreats extends StatefulWidget {
  const ColdTreats({Key? key}) : super(key: key);

  @override
  State<ColdTreats> createState() => _ColdTreatsState();
}

class _ColdTreatsState extends State<ColdTreats> {
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  GestureDetector(
                    onDoubleTap: () {
                      addFavorites("Cold Treats", "images/category_images/CULINARIES/ColdTreats.jpg");
                    },
                    child: Container(
                      width: 325,
                      height: 200,
                      decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                              image: AssetImage("images/category_images/CULINARIES/ColdTreats.jpg"),
                              fit: BoxFit.fill
                          )
                      ),
                    ),
