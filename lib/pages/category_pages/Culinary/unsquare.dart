...
class UNSquare extends StatefulWidget {
  const UNSquare({Key? key}) : super(key: key);

  @override
  State<UNSquare> createState() => _UNSquareState();
}

class _UNSquareState extends State<UNSquare> {
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  GestureDetector(
                    onDoubleTap: () {
                      addFavorites("UN Square", "images/category_images/CULINARIES/UNsquare.jpg");
                    },
                    child: Container(
                      width: 325,
                      height: 200,
