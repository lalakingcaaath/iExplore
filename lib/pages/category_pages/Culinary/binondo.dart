...
class Binondo extends StatefulWidget {
  const Binondo({Key? key}) : super(key: key);

  @override
  State<Binondo> createState() => _BinondoState();
}

class _BinondoState extends State<Binondo> {
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  GestureDetector(
                    onDoubleTap: () {
                      addFavorites("Binondo", "images/category_images/CULINARIES/binondo 1.jpeg");
                    },
                    child: Container(
                      width: 325,
                      height: 200,
