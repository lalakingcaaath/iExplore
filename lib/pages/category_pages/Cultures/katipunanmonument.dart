...
class KatipunanMonument extends StatefulWidget {
  const KatipunanMonument({Key? key}) : super(key: key);

  @override
  State<KatipunanMonument> createState() => _KatipunanMonumentState();
}

class _KatipunanMonumentState extends State<KatipunanMonument> {
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  GestureDetector(
                    onDoubleTap: () {
                      addFavorites("Katipunan Monument", "images/category_images/CULTURAL/KatipunanMonumentManila.jpg");
                    },
                    child: Container(
                      width: 325,
                      height: 200,
