...
class Malacanang extends StatefulWidget {
  const Malacanang({Key? key}) : super(key: key);

  @override
  State<Malacanang> createState() => _MalacanangState();
}
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  GestureDetector(
                    onDoubleTap: () {
                      addFavorites("Malacanang Palace", "images/category_images/CULTURAL/MalacanangPalace.jpeg");
                    },
                    child: Container(
                      width: 325,
                      height: 200,
