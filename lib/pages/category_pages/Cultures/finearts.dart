...
class FineArts extends StatefulWidget {
  const FineArts({Key? key}) : super(key: key);

  @override
  State<FineArts> createState() => _FineArtsState();
}
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  GestureDetector(
                    onDoubleTap: () {
                      addFavorites("National Museum of Fine Arts", "images/category_images/CULTURAL/National Museum of Fine Arts.jpg");
                    },
                    child: Container(
                      width: 325,
                      height: 200,
