...
class Antropology extends StatefulWidget {
  const Antropology({Key? key}) : super(key: key);

  @override
  State<Antropology> createState() => _AntropologyState();
}

class _AntropologyState extends State<Antropology> {
            ...
            children: [
              ...
              Row(
                  ...
                  children: [
                    Center(
                      child: Text(
                        "National Museum of Anthropology", style: TextStyle(
                          fontFamily: 'FSP-Demo',
