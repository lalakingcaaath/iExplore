...
class Museo extends StatefulWidget {
  const Museo({Key? key}) : super(key: key);

  @override
  State<Museo> createState() => _MuseoState();
}

class _MuseoState extends State<Museo> {
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  GestureDetector(
                    onDoubleTap: () {
                      addFavorites("Museo de Intramuros", "images/category_images/CULTURAL/Museo de Intramuros.jpg");
                    },
                    child: Container(
                      width: 325,
                      height: 200,
