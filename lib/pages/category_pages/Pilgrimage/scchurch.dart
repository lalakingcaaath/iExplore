...
class SantaCruzChurch extends StatefulWidget {
  const SantaCruzChurch({Key? key}) : super(key: key);

  @override
  State<SantaCruzChurch> createState() => _SantaCruzChurchState();
}

class _SantaCruzChurchState extends State<SantaCruzChurch> {
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  GestureDetector(
                    onDoubleTap: () {
                      addFavorites("Santa Cruz Church", "images/category_images/PILGRIMAGE/Santa Cruz Church.jpg");
                    },
                    child: Container(
                      width: 325,
                      height: 200,
