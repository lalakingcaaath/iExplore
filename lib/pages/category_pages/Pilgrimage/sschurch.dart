...
class SanSebastianChurch extends StatefulWidget {
  const SanSebastianChurch({Key? key}) : super(key: key);

  @override
  State<SanSebastianChurch> createState() => _SanSebastianChurchState();
}

class _SanSebastianChurchState extends State<SanSebastianChurch> {
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  GestureDetector(
                    onDoubleTap: () {
                      addFavorites("San Sebastian Church", "images/category_images/PILGRIMAGE/San Sebastian Church.jpg");
                    },
                    child: Container(
                      width: 325,
                      height: 200,
