...
class BinondoChurch extends StatefulWidget {
  const BinondoChurch({Key? key}) : super(key: key);

  @override
  State<BinondoChurch> createState() => _BinondoChurchState();
}

class _BinondoChurchState extends State<BinondoChurch> {
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  GestureDetector(
                    onDoubleTap: () {
                      addFavorites("Binondo Church", "images/category_images/PILGRIMAGE/Binondo Church.jpg");
                    },
                    child: Container(
                      width: 325,
                      height: 200,
