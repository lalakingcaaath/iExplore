...
class PaulParishChurch extends StatefulWidget {
  const PaulParishChurch({Key? key}) : super(key: key);

  @override
  State<PaulParishChurch> createState() => _PaulParishChurchState();
}

class _PaulParishChurchState extends State<PaulParishChurch> {
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  GestureDetector(
                    onDoubleTap: () {
                      addFavorites("St. Vincent de Paul Parish Church", "images/category_images/PILGRIMAGE/St. Vincent de Paul Parish Church.jpg");
                    },
                    child: Container(
                      width: 325,
                      height: 200,
