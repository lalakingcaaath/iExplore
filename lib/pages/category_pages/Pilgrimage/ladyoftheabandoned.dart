...
class LadyOfTheAbandoned extends StatefulWidget {
  const LadyOfTheAbandoned({Key? key}) : super(key: key);

  @override
  State<LadyOfTheAbandoned> createState() => _LadyOfTheAbandonedState();
}

class _LadyOfTheAbandonedState extends State<LadyOfTheAbandoned> {
            ...
            children: [
              ...
              Row(
                  ...
                  children: [
                    Center(
                      child: Text(
                        "National Shrine of\nOur Lady of the Abandoned", textAlign: TextAlign.center, style: TextStyle(
                          fontFamily: 'FSP-Demo',
              ...
              Row(
                ...
                children: [
                  GestureDetector(
                    onDoubleTap: () {
                      addFavorites("National Shrine of\nOur Lady of the Abandoned", "images/category_images/PILGRIMAGE/National Shrine of Our Lady of the Abandoned.jpg");
                    },
                    child: Container(
                      width: 325,
                      height: 200,
