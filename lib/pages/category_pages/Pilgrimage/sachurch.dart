...
class SanAgustinChurch extends StatefulWidget {
  const SanAgustinChurch({Key? key}) : super(key: key);

  @override
  State<SanAgustinChurch> createState() => _SanAgustinChurchState();
}

class _SanAgustinChurchState extends State<SanAgustinChurch> {
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  GestureDetector(
                    onDoubleTap: () {
                      addFavorites("San Agustin Church", "images/category_images/PILGRIMAGE/San Agustin Church.jpg");
                    },
                    child: Container(
                      width: 325,
                      height: 200,
