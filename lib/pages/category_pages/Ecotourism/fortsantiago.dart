...
class FortSantiago extends StatefulWidget {
  const FortSantiago({Key? key}) : super(key: key);

  @override
  State<FortSantiago> createState() => _FortSantiagoState();
}

class _FortSantiagoState extends State<FortSantiago> {
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  GestureDetector(
                    onDoubleTap: () {
                      addFavorites("Intramuros Fort Santiago", "images/category_images/ECOTOURISM/Intramuros Fort Santiago.jpg");
                    },
                    child: Container(
                      width: 325,
                      height: 200,
