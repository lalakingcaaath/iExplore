...
class CasaManila extends StatefulWidget {
  const CasaManila({Key? key}) : super(key: key);

  @override
  State<CasaManila> createState() => _CasaManilaState();
}

class _CasaManilaState extends State<CasaManila> {
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  GestureDetector(
                    onDoubleTap: () {
                      addFavorites("Casa Manila", "images/category_images/ECOTOURISM/Casa Manila.jpg");
                    },
                    child: Container(
                      width: 325,
                      height: 200,
