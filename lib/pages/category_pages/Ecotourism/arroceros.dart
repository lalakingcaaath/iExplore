...
class Arroceros extends StatefulWidget {
  const Arroceros({Key? key}) : super(key: key);

  @override
  State<Arroceros> createState() => _ArrocerosState();
}

class _ArrocerosState extends State<Arroceros> {
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  GestureDetector(
                    onDoubleTap: () {
                      addFavorites("Arroceros Forest Park", "images/category_images/ECOTOURISM/Arroceros Forest Park.jpg");
                    },
                    child: Container(
                      width: 325,
                      height: 200,
