...
class FortDungeon extends StatefulWidget {
  const FortDungeon({Key? key}) : super(key: key);

  @override
  State<FortDungeon> createState() => _FortDungeonState();
}

class _FortDungeonState extends State<FortDungeon> {
  ...
  void fetchData() {
    firestoreInstance.collection('tour_categories').doc('Ecotourism').get().then((DocumentSnapshot documentSnapshot) {
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  GestureDetector(
                    onDoubleTap: () {
                      addFavorites("The Dungeons of Fort Santiago", "images/category_images/ECOTOURISM/The Dungeons of Fort Santiago-2.jpg");
                    },
                    child: Container(
                      width: 325,
                      height: 200,
