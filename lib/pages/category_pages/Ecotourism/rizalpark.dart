...
class RizalPark extends StatefulWidget {
  const RizalPark({Key? key}) : super(key: key);

  @override
  State<RizalPark> createState() => _RizalParkState();
}

class _RizalParkState extends State<RizalPark> {
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  GestureDetector(
                    onDoubleTap: () {
                      addFavorites("Rizal Park", "images/category_images/ECOTOURISM/Rizal Park.jpg");
                    },
                    child: Container(
                      width: 325,
                      height: 200,
