...
class OceanPark extends StatefulWidget {
  const OceanPark({Key? key}) : super(key: key);

  @override
  State<OceanPark> createState() => _OceanParkState();
}

class _OceanParkState extends State<OceanPark> {
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  GestureDetector(
                    onDoubleTap: () {
                      addFavorites("Manila Ocean Park", "images/category_images/ECOTOURISM/Manila Ocean Park.jpg");
                    },
                    child: Container(
                      width: 325,
                      height: 200,
