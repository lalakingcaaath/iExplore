...
class MehanGarden extends StatefulWidget {
  const MehanGarden({Key? key}) : super(key: key);

  @override
  State<MehanGarden> createState() => _MehanGardenState();
}

class _MehanGardenState extends State<MehanGarden> {
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  GestureDetector(
                    onDoubleTap: () {
                      addFavorites("Mehan Garden", "images/category_images/ECOTOURISM/MehanGarden.jpg");
                    },
                    child: Container(
                      width: 325,
                      height: 200,
