...
class CraftAcademy extends StatefulWidget {
  const CraftAcademy({Key? key}) : super(key: key);

  @override
  State<CraftAcademy> createState() => _CraftAcademyState();
}

class _CraftAcademyState extends State<CraftAcademy> {
  ...
  void fetchData() {
    firestoreInstance.collection('tour_categories').doc('Adventure').get().then((DocumentSnapshot documentSnapshot) {
      if (documentSnapshot.exists) {
        Map<String, dynamic> data = documentSnapshot.data() as Map<String, dynamic>;
        setState(() {
          _data = data["CraftAcademy"] ?? "";
        });
      } else {
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  GestureDetector(
                    onDoubleTap: () {
                      addFavorites("Craft Academy", "images/category_images/ADVENTURE/Craft Academy.jpg");
                    },
                    child: Container(
                      width: 325,
                      height: 200,
