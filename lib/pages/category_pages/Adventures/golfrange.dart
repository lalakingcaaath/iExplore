...
class GolfRange extends StatefulWidget {
  const GolfRange({Key? key}) : super(key: key);

  @override
  State<GolfRange> createState() => _GolfRangeState();
}

class _GolfRangeState extends State<GolfRange> {
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  GestureDetector(
                    onDoubleTap: () {
                      addFavorites("Intramuros Golf Club", "images/category_images/ADVENTURE/ClubIntramurosGolf.jpg");
                    },
                    child: Container(
                      width: 325,
                      height: 200,
