...
class Kalesa extends StatefulWidget {
  const Kalesa({Key? key}) : super(key: key);

  @override
  State<Kalesa> createState() => _KalesaState();
}

class _KalesaState extends State<Kalesa> {
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  GestureDetector(
                    onDoubleTap: () {
                      addFavorites("Kalesa", "images/category_images/ADVENTURE/Kalesa.jpg");
                    },
                    child: Container(
                      width: 325,
                      height: 200,
