...
class Escolta extends StatefulWidget {
  const Escolta({Key? key}) : super(key: key);

  @override
  State<Escolta> createState() => _EscoltaState();
}

class _EscoltaState extends State<Escolta> {
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  GestureDetector(
                    onDoubleTap: () {
                      addFavorites("Escolta", "images/category_images/LEISURE/Escolta.JPG");
                    },
                    child: Container(
                      width: 325,
                      height: 200,
