...
class PlazaRoma extends StatefulWidget {
  const PlazaRoma({Key? key}) : super(key: key);

  @override
  State<PlazaRoma> createState() => _PlazaRomaState();
}

class _PlazaRomaState extends State<PlazaRoma> {
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  GestureDetector(
                    onDoubleTap: () {
                      addFavorites("Plaza Roma", "images/category_images/LEISURE/PlazaRoma.jpg");
                    },
                    child: Container(
                      width: 325,
                      height: 200,
