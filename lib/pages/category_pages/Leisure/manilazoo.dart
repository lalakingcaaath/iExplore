...
class ManilaZoo extends StatefulWidget {
  const ManilaZoo({Key? key}) : super(key: key);

  @override
  State<ManilaZoo> createState() => _ManilaZooState();
}

class _ManilaZooState extends State<ManilaZoo> {
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  GestureDetector(
                    onDoubleTap: () {
                      addFavorites("Manila Zoo", "images/category_images/LEISURE/ManilaZoo.jpg");
                    },
                    child: Container(
                      width: 325,
                      height: 200,
