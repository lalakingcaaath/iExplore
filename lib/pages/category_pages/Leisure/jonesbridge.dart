...
class JonesBridge extends StatefulWidget {
  const JonesBridge({Key? key}) : super(key: key);

  @override
  State<JonesBridge> createState() => _JonesBridgeState();
}

class _JonesBridgeState extends State<JonesBridge> {
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  GestureDetector(
                    onDoubleTap: () {
                      addFavorites("Jones Bridge", "images/category_images/LEISURE/JonesBridge.jpg");
                    },
                    child: Container(
                      width: 325,
                      height: 200,
