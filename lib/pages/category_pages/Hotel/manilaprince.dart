...
class ManilaPrince extends StatefulWidget {
  const ManilaPrince({Key? key}) : super(key: key);

  @override
  State<ManilaPrince> createState() => _ManilaPrinceState();
}

class _ManilaPrinceState extends State<ManilaPrince> {
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  GestureDetector(
                    onDoubleTap: () {
                      addFavorites("Manila Prince", "images/category_images/HOTELS/Manila Prince.jpg");
                    },
                    child: Container(
                      width: 325,
                      height: 200,
