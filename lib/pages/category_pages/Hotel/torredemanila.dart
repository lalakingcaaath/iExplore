...
class TorreDeManila extends StatefulWidget {
  const TorreDeManila({Key? key}) : super(key: key);

  @override
  State<TorreDeManila> createState() => _TorreDeManilaState();
}

class _TorreDeManilaState extends State<TorreDeManila> {
            ...
            children: [
              ...
              Row(
                  ...
                  children: [
                    Center(
                      child: Text(
                        "Torre De Manila", style: TextStyle(
                          fontFamily: 'FSP-Demo',
              ...
              Row(
                ...
                children: [
                  GestureDetector(
                    onDoubleTap: () {
                      addFavorites("Torre De Manila", "images/category_images/HOTELS/Torre De Manila.png");
                    },
                    child: Container(
                      width: 325,
                      height: 200,
