...
class BayLeaf extends StatefulWidget {
  const BayLeaf({Key? key}) : super(key: key);

  @override
  State<BayLeaf> createState() => _BayLeafState();
}

class _BayLeafState extends State<BayLeaf> {
            ...
            children: [
              ...
              Row(
                  ...
                  children: [
                    Center(
                      child: Text(
                        "The Bayleaf Intramuros Hotel", style: TextStyle(
                          fontFamily: 'FSP-Demo',
              ...
              Row(
                ...
                children: [
                  GestureDetector(
                    onDoubleTap: () {
                      addFavorites("The Bayleaf Intramuros Hotel", "images/category_images/HOTELS/The Bayleaf Intramuros Hotel.jpg");
                    },
                    child: Container(
                      width: 325,
                      height: 200,
