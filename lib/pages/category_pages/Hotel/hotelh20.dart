...
class HotelH20 extends StatefulWidget {
  const HotelH20({Key? key}) : super(key: key);

  @override
  State<HotelH20> createState() => _HotelH20State();
}

class _HotelH20State extends State<HotelH20> {
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  GestureDetector(
                    onDoubleTap: () {
                      addFavorites("Hotel H20", "images/category_images/HOTELS/Hotel H20.jpg");
                    },
                    child: Container(
                      width: 325,
                      height: 200,
