...
class LotusHotel extends StatefulWidget {
  const LotusHotel({Key? key}) : super(key: key);

  @override
  State<LotusHotel> createState() => _LotusHotelState();
}

class _LotusHotelState extends State<LotusHotel> {
            ...
            children: [
              ...
              Row(
                  ...
                  children: [
                    Center(
                      child: Text(
                        "Manila Lotus Hotel", style: TextStyle(
                          fontFamily: 'FSP-Demo',
              ...
              Row(
                ...
                children: [
                  GestureDetector(
                    onDoubleTap: () {
                      addFavorites("Manila Lotus Hotel", "images/category_images/HOTELS/Manila Lotus Hotel.jpg");
                    },
                    child: Container(
                      width: 325,
                      height: 200,
