...
class RPHotel extends StatefulWidget {
  const RPHotel({Key? key}) : super(key: key);

  @override
  State<RPHotel> createState() => _RPHotelState();
}

class _RPHotelState extends State<RPHotel> {
            ...
            children: [
              ...
              Row(
                  ...
                  children: [
                    Center(
                      child: Text(
                        "Rizal Park Hotel", style: TextStyle(
                          fontFamily: 'FSP-Demo',
              ...
              Row(
                ...
                children: [
                  GestureDetector(
                    onDoubleTap: () {
                      addFavorites("Rizal Park Hotel", "images/category_images/HOTELS/Rizal Park Hotel.jpg");
                    },
                    child: Container(
                      width: 325,
                      height: 200,
