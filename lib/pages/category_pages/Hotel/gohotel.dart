...
class GoHotel extends StatefulWidget {
  const GoHotel({Key? key}) : super(key: key);

  @override
  State<GoHotel> createState() => _GoHotelState();
}

class _GoHotelState extends State<GoHotel> {
            ...
            children: [
              ...
              Row(
                  ...
                  children: [
                    Center(
                      child: Text(
                        "Go Hotels Ermita", style: TextStyle(
                          fontFamily: 'FSP-Demo',
              ...
              Row(
                ...
                children: [
                  GestureDetector(
                    onDoubleTap: () {
                      addFavorites("Go Hotels Ermita", "images/category_images/HOTELS/Go Hotels Ermita.jpg");
                    },
                    child: Container(
                      width: 325,
                      height: 200,
